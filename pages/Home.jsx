            ...
            <section id="home" className="home-container container">
                <div className="text-container">
                    <div className="home-logo">
                        <Image alt="QTMA logo" src={ qtmaLogo.src } width={ 346 } height={ 93.71 }
                               className="QTMA-logo"/>
                    </div>
                    ...
                    { isMobile ? (
                        <div className="startup-art-container">
                            <Image alt="illustration" src={ startup } width={ 452 } height={ 462.17 }
                                   className="startup-art"/>
                        </div>
                    ) : (
                        ""
                    ) }
                    <SLink className="CTA" offset={ -104 } to="WhatIsQTMA" smooth={ true } duration={ 100 }>
                        Learn More
                    </SLink>
                </div>
                { !isMobile ? (
