...
import Founding from "../../public/assets/Data/Founding.png";
import Expansion from "../../public/assets/Data/Expansion.png";
import Initiatives from "../../public/assets/Data/Initiatives.png";
          ...
          <div className="history-events-container">
            ...
            <div className="event">
              <div className="event-content">
                ...
                <h2>The Founding</h2>
                <p>
                  QTMA is founded by Justin Herlick and Aleko Kiriakou to bridge the gap between Queen’s
                  University and the broader tech industry. Initially only a Commerce club, QTMA primarily
            ...
            <div className="event">
              <div className="event-content">
                ...
                <p>
                  QTMA expands its presence by launching Insights – a yearly research pitch competition
                  amongst internal members – and Byte Size – the club’s weekly tech newsletters. The club
                  becomes accessible to Engineering and Computer Science students. In addition, Project
                  Tädistö is rolled out as an initiative for internal technical teams of three to develop
                  apps.
                </p>
              </div>
              <div className="event-image">
